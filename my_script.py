...
import sys
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
# Created by transposed messenger on 6.11.2016
#
# Reformatted for Pomona College CS51 Course
# Author: Juan Zamudio
...
mailTxt = open("cs51recipients2.txt", 'r')
...
for k, items in zip (range(len(recipients)), show):
	...
	part1 = MIMEText(template.format(variation1[0], names[k], labNames[0], variation3[0]))
	msg.attach(part1)
